...
codec gain control plus ESP32-SpeexDSP preprocessing keep normal speech below
clipping before PCM12 packing; current codec volume, SpeexDSP settings, and
limiter targets are reported through the device-info JSON when available.
