...
codec gain control and automatic level control keep normal speech below clipping
before PCM12 packing; current codec volume, gain, and limiter targets are
